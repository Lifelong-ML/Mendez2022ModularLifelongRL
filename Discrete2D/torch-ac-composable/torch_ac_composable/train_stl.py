...
experiment_name = 'MiniGrid_1M_H64_STL_PPO'
job_name = 'train_' + experiment_name + '_seed_{}_task_{}' 
...
for seed in range(num_seeds):
    for task_id in range(num_tasks):
        ...
        results_dir = os.path.join('..', '..', 'pt', experiment_name, job_name.format(seed, task_id), 'results')
